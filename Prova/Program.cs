/*
 ...
 Mesmo que seu codigo nao esteja funcionando totalmente, ele sera analisado e podera receber uma pontuacao proporcional ao que tiver
sido feito
 ...
 Eh permitida consulta a internet e ao material de aula, mas nao eh permitida comunicacao entre os alunos e alunas, nem uso de celular
durante a prova
...
namespace Prova1
{
    ...
    class Controle
    {
        ...
        public int GetNumeroQuiosquesApenasNoite()
        {
            ...
            {
                if (quiosque.Horario.Equals("Noite"))
                {
        ...
        public string GetEmpresasSalgadoManha()
        {
            ...
            foreach (Quiosque quiosque in Quiosques)
            {
                if (quiosque.ServeSalgado)
                {
                    if (quiosque.Horario.Equals("Manha") || quiosque.Horario.Equals("Ambos"))
                    {
        ...
        public string GetAlimentoMaisPreferido()
        {
            ...
            {
                if (bloco.AlimentoPreferido.Equals("Salgado"))
                {
                    salgado++;
                }
                else if (bloco.AlimentoPreferido.Equals("Doce"))
                {
                    doce++;
                }
                else if (bloco.AlimentoPreferido.Equals("Bebida"))
                {
                    bebida++;
                }
            }
            ...
            else if (bebida > doce && bebida > salgado)
            {
        ...
        // - o bloco tem que estar aberto em todo horario de funcionamento do quiosque (mas nao tem problema se o quiosqueestiver fechado em parte do horario do bloco)
 ...
 public void AlocarTodoMundo()
        {
            ...
            foreach (Bloco bloco in Blocos)
            {
                foreach (Quiosque quiosque in Quiosques)
                {
                    ...
                    else if (quiosque.ServeDoce && bloco.AlimentoPreferido.Equals("Doce"))
                    {
                        serveAlimento = true;
                    }
                    else if (quiosque.ServeSalgado && bloco.AlimentoPreferido.Equals("Salgado"))
                    {
                        serveAlimento = true;
                    }
                    else
